...
/// If NO, the status bar style will be set according to the navigationBarStyle and navigationBarTintColor properties.
/// Defaults to NO.
/// @see navigationBarStyle, navigationBarTintColor
